/**
 * About.jsx — About the creator and the project
 *
 * Tells visitors who nonydev is and why this hub was built.
 */

// What the hub offers — shown in a bullet list
const OFFERINGS = [
  'Full semester-by-semester breakdowns for CS1–CS4 and IT1–IT4',
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      <div className="bg-slate-900/60 border border-slate-800 rounded-2xl p-8 mb-10 flex flex-col sm:flex-row gap-6 items-start">
        ...
        <div>
          ...
          <p className="text-slate-500 text-sm mb-4">
            CS student · builder · open-source enthusiast
          </p>
      ...
      <div className="bg-slate-900/50 border border-slate-800 rounded-2xl p-6">
        <h2 className="text-slate-100 font-bold mb-4">Built With</h2>
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          {[
            ...
            >
              <div className="font-mono text-slate-100 text-sm font-semibold">{tech.name}</div>
