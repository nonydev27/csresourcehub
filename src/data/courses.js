...
export const courses = {
  ...
  cs: [
...

    {
      ...
      cardBorder: "border-blue-300 hover:border-blue-600",
      cardGlow: "hover:shadow-blue-500/15",
...

    {
      ...
      cardBorder: "border-violet-300 hover:border-violet-600",
      cardGlow: "hover:shadow-violet-500/15",
...

    {
      ...
      cardGlow: "hover:shadow-rose-500/15",
  ...
  it: [
    {
      ...
      cardGlow: "hover:shadow-cyan-500/15",
...

    {
      ...
      cardGlow: "hover:shadow-amber-500/15",
...

    {
      ...
      cardGlow: "hover:shadow-lime-500/15",
      accentText: "text-lime-700",
      badgeBg: "bg-lime-50 text-lime-700 border border-lime-300",
      description:
